...
class NetworkService {
  ...
  static const API_BREADS_GET_VOTES = "/v1/votes";
  static const API_CREATE_VOTE = "/v1/votes";

  // headers
  static Map<String, String> headers = {
    'Content-Type': 'application/json',
    'x-api-key': 'ca977bb9-eb6d-4d44-8073-c519b52808e4',
  };
  ...
  // bodies
  static Map<String, dynamic> bodyVotes(String imageId, int value) {
    Map<String, dynamic> map = {
      "image_id": imageId,
      //"sub_id": subId,
      "value": value
